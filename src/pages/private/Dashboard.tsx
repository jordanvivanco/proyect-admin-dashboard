import { Box, Stack, Button, Menu, Divider, ListItemIcon, MenuItem, Avatar, Tooltip, TextField, InputBase, Typography, IconButton } from "@mui/material";
    ...
    return (
        <Box sx={dashboard}>
            ...
            <Box sx={viewport}>
                ...
                <Box sx={content}>
                    <div style={{height: "1000px", paddingLeft: paddingleft, transition: "all 0.1s" }}>
                        hello word
                    </div>
                </Box>
            </Box>
